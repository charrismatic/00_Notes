Move to ~/.config directory or globally at /usr/share 

```
mv *.xml $HOME/.gnome2/gedit/styles/. 
```

# GEDIT Paths 

```sh
    THEME_DIR=$HOME:.local/share/gedit/styles
    SNIPPET_DIR=/usr/share/gedit/plugins/snippets
    KEYMAPS_PATH=/usr/share/gedit/plugins/modelines/language-mappings 
    TOOLS_PATH=/usr/share/gedit/plugins/externaltools/tools/
    UITOOLS_PATH=/usr/share/gedit/plugins/externaltools/ui
```
